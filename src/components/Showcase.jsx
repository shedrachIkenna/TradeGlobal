...
const Showcase = () => {
    return (
        <div className="md:mt-16 mt-4 pt-8 md:flex md:flex-row border-t md:p-5 h-96">
            ...
            <div className="md:basis-2/5 grid grid-cols-5 md:mt-0 mt-14 px-5 grid-rows-3 grid-flow-col">
                <img src={img5} alt="pics" className="col-start-1 col-span-4 row-start-1 row-span-2 w-full h-auto"/>
